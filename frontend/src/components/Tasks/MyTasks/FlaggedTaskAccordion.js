...
const FlaggedTaskAccordion = ({taskData, deleteTask, setChangeTask, user}) => {
        ...
        <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} >
                ...
                <AccordionDetails>
                    ...
                    <Box sx={{textAlign: 'center', mt: 5}}>
                        <Button variant="contained" color="primary" size="small" sx={{ mb: 2, mr: 3}}>View</Button>
                        {flagged && <Button variant="contained" color="error" size="small" sx={{ mb: 2}} onClick={() => setFlagged(!flagged)}>Unflag</Button>}
                        {!flagged && <Button color="error" size="small" sx={{ mb: 2}} onClick={() => setFlagged(!flagged)}>Flag</Button>}
